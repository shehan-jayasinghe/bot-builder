...
**Agentic migration:** [../agentic/updets/api-migration-agentic.md](../agentic/updets/api-migration-agentic.md) — **no** route or schema change. List items do not include `capability_catalog` or `routing_hint`.
