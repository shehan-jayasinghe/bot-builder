...
**Agentic migration:** Phase A **Done** — no route/schema change. Phase B **Done** — same URLs; runtime no longer auto-starts workflows on first message. See [../agentic/updets/api-migration-agentic-phase-b.md](../agentic/updets/api-migration-agentic-phase-b.md).
