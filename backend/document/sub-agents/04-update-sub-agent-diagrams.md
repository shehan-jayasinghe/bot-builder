...
**Agentic migration:** Phase A **Done**. Phase B **no REST change**. Phase C **planned** — sub-agent chat RAG via `search_knowledge` (no REST change). See [../agentic/updets/api-migration-agentic-phase-c.md](../agentic/updets/api-migration-agentic-phase-c.md).
